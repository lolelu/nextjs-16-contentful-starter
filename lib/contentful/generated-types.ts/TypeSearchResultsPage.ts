...
export interface TypeSearchResultsPageFields {
    ...
    productsTabLabel: EntryFieldTypes.Symbol;
    productsActionLabel: EntryFieldTypes.Symbol;
    recipesTabLabel: EntryFieldTypes.Symbol;
    recipesActionLabel: EntryFieldTypes.Symbol;
    faqsTabLabel: EntryFieldTypes.Symbol;
    faqsActionLabel: EntryFieldTypes.Symbol;
    blogsTabLabel: EntryFieldTypes.Symbol;
    blogsActionLabel: EntryFieldTypes.Symbol;
    usefulInformationTabLabel: EntryFieldTypes.Symbol;
    usefulInformationActionLabel: EntryFieldTypes.Symbol;
    priceFreeLabel: EntryFieldTypes.Symbol;
    noResultsText: EntryFieldTypes.RichText;
    noResultsNavigationLink: EntryFieldTypes.EntryLink<TypeNavigationLinkSkeleton>;
...
export type TypeSearchResultsPageSkeleton = EntrySkeletonType<TypeSearchResultsPageFields, "searchResultsPage">;
export type TypeSearchResultsPage<Modifiers extends ChainModifiers, Locales extends LocaleCode = LocaleCode> = Entry<TypeSearchResultsPageSkeleton, Modifiers, Locales>;
