...
export interface TypeNotFoundPageFields {
    ...
    pageNotFoundText: EntryFieldTypes.RichText;
    pageNotFoundNavigationLink: EntryFieldTypes.EntryLink<TypeNavigationLinkSkeleton>;
...
export type TypeNotFoundPageSkeleton = EntrySkeletonType<TypeNotFoundPageFields, "notFoundPage">;
export type TypeNotFoundPage<Modifiers extends ChainModifiers, Locales extends LocaleCode = LocaleCode> = Entry<TypeNotFoundPageSkeleton, Modifiers, Locales>;
